    ...
    document.getElementById('upload').onclick = function() {
      ...
      var inputimg = document.getElementById('inputimg').value;
        if (selectImgFlag == 0){
          ...
          var rownum;
          drawToName(context,toNameVal,0,310,'#ffffff');
          if (customFlag) {
            ...
            rownum = drawText(context,blessValCustom,0,330,customWidth,'#ffffff');
          } else {
            rownum = drawText(context,blessValStr,0,330,440,'#ffffff');
          }
